...
def plot_fleet_data(csv_no_topsis, csv_topsis):
    ...
    ax1.set_xlabel('Year')
    ax1.set_ylabel('TotalCost', color='tab:blue')
...
# Example Usage
plot_fleet_data('data/output/tradeoff/notopsis/multiobjective_summary.csv', 'data/output/tradeoff/topsis/multiobjective_summary.csv')
